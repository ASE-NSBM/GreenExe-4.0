...
<section class="gx-section relative isolate overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
            data-background-image="{{ asset($image) }}" aria-hidden="true"></div>
    ...
    <div class="absolute inset-0 bg-linear-to-b from-dark-navy/60 via-transparent to-dark-navy" aria-hidden="true"></div>
